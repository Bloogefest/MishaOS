...
i686-elf-as bootloader.asm -o build/bootloader_s.o
i686-elf-ld -nostdlib --warn-common --no-undefined --fatal-warnings --build-id=sha1 -z nocombreloc -shared -Bsymbolic -Lgnu-efi/ia32/lib -Lgnu-efi/ia32/gnuefi -Tgnu-efi/gnuefi/elf_ia32_efi.lds gnu-efi/ia32/gnuefi/crt0-efi-ia32.o build/bootloader.o build/bootloader_s.o -o build/bootloader.so -lgnuefi -lefi $(i686-elf-gcc -print-libgcc-file-name)
...
x86_64-elf-as bootloader.asm -o build/bootloader_s.o
x86_64-elf-ld -nostdlib --warn-common --no-undefined --fatal-warnings --build-id=sha1 -z nocombreloc -shared -Bsymbolic -Lgnu-efi/x86_64/lib -Lgnu-efi/x86_64/gnuefi -Tgnu-efi/gnuefi/elf_x86_64_efi.lds gnu-efi/x86_64/gnuefi/crt0-efi-x86_64.o build/bootloader.o build/bootloader_s.o -o build/bootloader.so -lgnuefi -lefi $(x86_64-elf-gcc -print-libgcc-file-name)
