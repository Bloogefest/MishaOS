...
if exist .\efi\boot\bootia32.efi then
 .\efi\boot\bootia32.efi
 goto END
endif

if exist fs0:\efi\boot\bootia32.efi then
 fs0:
 efi\boot\bootia32.efi
 goto END
endif

if exist fs1:\efi\boot\bootia32.efi then
 fs1:
 efi\boot\bootia32.efi
 goto END
endif

if exist fs2:\efi\boot\bootia32.efi then
 fs2:
 echo Found bootloader on fs2:
 efi\boot\bootia32.efi
 goto END
...
if exist fs3:\efi\boot\bootia32.efi then
 fs3:
 echo Found bootloader on fs3:
 efi\boot\bootia32.efi
 goto END
...
if exist fs4:\efi\boot\bootia32.efi then
 fs4:
 echo Found bootloader on fs4:
 efi\boot\bootia32.efi
 goto END
...
if exist fs5:\efi\boot\bootia32.efi then
 fs5:
 echo Found bootloader on fs5:
 efi\boot\bootia32.efi
 goto END
...
if exist fs6:\efi\boot\bootia32.efi then
 fs6:
 echo Found bootloader on fs6:
 efi\boot\bootia32.efi
 goto END
...
if exist fs7:\efi\boot\bootia32.efi then
 fs7:
 echo Found bootloader on fs7:
 efi\boot\bootia32.efi
 goto END
